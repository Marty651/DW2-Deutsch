...
Write-Host -ForegroundColor Green "Alte Version:"
Write-Host -ForegroundColor Green "- Ohne Information zu Zeilennummern."
Write-Host -ForegroundColor Green "- Benötigt gleiche Struktur (Reihenfolge/Einschübe machen Probleme)."
Write-Host -ForegroundColor Green "- Funktioniert mit den alten Regeln (ohne ID-Regel)."
Write-Host
